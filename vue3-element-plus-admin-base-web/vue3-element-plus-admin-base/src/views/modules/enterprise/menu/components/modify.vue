<template>
  <el-dialog width="450px" title="修改" v-model="visible" :close-on-click-modal="false" @closed="dialogClosedHandle"
    append-to-body draggable>
    <el-form :model="form" :rules="rules" ref="refForm" @keyup.enter="submit()" label-position="top">
      <el-form-item label="菜单权限" prop="menu_ids">
        <el-cascader class="width-full" ref="refCascader" v-model="form.menu_ids" :options="menus"
