<template>
  <Container>
    <template #header>
      <div class="panel-title margin_b-10 font-size-18">{{ $t('unieap.bakerstreet.playmgt.playerblacklist') }}</div>
    </template>
    <template #default>
      <el-table ref="refTable" v-loading="loading" :data="list"
        ...
        <el-table-column align="center" :label="$t('unieap.bakerstreet.playmgt.playerName')" prop="name"
          width="200" />
      </el-table>
    </template>
  </Container>
