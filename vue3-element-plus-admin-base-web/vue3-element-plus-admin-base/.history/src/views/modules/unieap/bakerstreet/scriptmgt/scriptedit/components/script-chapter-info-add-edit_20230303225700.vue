  ...
  <Container>
    ...
    <template #default>
      <el-table ref="refTable" v-loading="loading" :data="list" @selection-change="selectionHandle"
        ...
        <el-table-column align="center" :label="$t('unieap.bakerstreet.scriptmgt.chapterNumber')" prop="chapterNumberDesc"
          width="100" />
        <el-table-column align="center" :label="$t('unieap.bakerstreet.scriptmgt.roleName')" prop="roleName"
          width="100" />
