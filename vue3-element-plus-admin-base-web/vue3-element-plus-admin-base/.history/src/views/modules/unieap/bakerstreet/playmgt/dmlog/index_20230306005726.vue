      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-table key="DMBrowse" ref="refTableDMBrowse" v-loading="loading" :data="listDMBrowse"
            ...
            <el-table-column align="center" :label="$t('unieap.bakerstreet.scriptmgt.scriptName')" prop="scriptName"
              width="200" />
            <el-table-column align="center" :label="$t('unieap.bakerstreet.scriptmgt.dmBrowseTime')" prop="dmBrowseTime"
              width="230" />
          </el-table>
        </el-col>
      </el-row>
...
//自定包引入
import { dmPlayPageApi, dmBrowsePageApi, playerDicApi, infoApi } from '@/api/unieap/bakerstreet/playmgt'
