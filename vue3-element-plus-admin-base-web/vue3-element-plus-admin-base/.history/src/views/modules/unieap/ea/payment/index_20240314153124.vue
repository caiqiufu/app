  ...
  <Container>
    ...
    <template #default>
      <el-table ref="refTable" v-loading="loading" :data="list" @selection-change="selectionHandle"
        ...
        <el-table-column align="center" label="任务名称" prop="name" width="200" sortable="custom" />
        <el-table-column align="center" label="任务类型" prop="typeDesc" width="200" />
        <el-table-column align="center" label="是否提醒" prop="notifyFlagDesc" width="200" />
        <el-table-column align="center" label="提醒周期" prop="notifyCron" width="200" />
        <el-table-column align="center" label="提醒消息模版" prop="messageTemplate" width="200" />
...
export default defineComponent({
  ...
  setup() {
    ...
    const data = reactive({
      loading: false,
      visible: false,
      optionBillType: [{ key: "1", "label": "全部", "value": "0" }, { key: "2", "label": "欠费", "value": "2" }],
      form: {
        sort: "id",
        dir: "asc",
        userCode: "",
