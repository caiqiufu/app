  ...
  <el-dialog width="600px" :title="form.id ? $t('unieap.comm.update') : $t('unieap.comm.create')" v-model="visible"
    ...
    <el-form v-loading="loading" :model="form" :rules="rules" ref="refForm" label-width="150px" label-position="right">
      <el-form-item label="用户" prop="userCode">
        <el-input v-model="form.userCode" disabled  maxlength="32" show-word-limit
          style="width: 300px" />
      </el-form-item>
      <el-form-item label="账户" prop="accountCode">
        <el-input v-model="form.accountCode" disabled  maxlength="32" show-word-limit
          style="width: 300px" />
      </el-form-item>
      <el-form-item label="账单金额" prop="outstandingAmount">
        <el-input v-model="form.outstandingAmount" disabled  maxlength="32" show-word-limit
          style="width: 300px" />
      </el-form-item>
      <el-form-item label="支付金额" prop="outstandingAmount">
        <el-input v-model="form.outstandingAmount"  maxlength="32" show-word-limit
          style="width: 300px" />
      </el-form-item>
      ...
      <el-form-item label="支付账号" prop="accountNo">
        <el-input v-model="form.accountNo"  maxlength="32" show-word-limit
          style="width: 300px" />
      </el-form-item>
      ...
      <el-form-item label="优先级" prop="priority">
        <el-input v-model="form.priority" :placeholder="$t('unieap.comm.plsInput')" maxlength="32"
          style="width: 300px" />
      </el-form-item>
      <el-form-item label="提醒周期" prop="notifyCron">
        <el-input type="textarea" :rows="3" v-model="form.notifyCron" :placeholder="$t('unieap.comm.plsInput')"
          style="width: 300px" />
      </el-form-item>
      <el-form-item label="提醒消息模版" prop="messageTemplate">
        <el-input type="textarea" :rows="3" v-model="form.messageTemplate" :placeholder="$t('unieap.comm.plsInput')"
          style="width: 300px" />
      </el-form-item>
