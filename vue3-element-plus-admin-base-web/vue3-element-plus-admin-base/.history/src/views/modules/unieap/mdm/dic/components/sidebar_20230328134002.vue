      ...
      <el-tree
        ...
        <template #default="{node, data}">
          <div class="node-box font-size-14 flex-item_f-1 flex-box flex_j_c-space-between flex_a_i-center">
            <div class="node-label flex-item_f-1 margin_r-10 ellipse">{{data.text}}</div>
            <div class="node-button-box">
              ...
              <el-tag v-if="data.type === 0">分组{{data.name_cn}}</el-tag>
              <el-tag type="success" v-else-if="data.type === 1">字典值{{data.name_cn}}</el-tag>
            </div>
          </div>
        </template>
      </el-tree>
