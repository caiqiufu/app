        ...
        <template #default="{node, data}">
          <div class="node-box font-size-14 flex-item_f-1 flex-box flex_j_c-space-between flex_a_i-center">
            ...
            <div class="node-button-box">
              ...
              <el-tag v-if="data.type === 0">{{MenuType[data.type]}}||{{data.name_cn}}</el-tag>
              <el-tag type="success" v-else-if="data.type === 1">{{MenuType[data.type]}}||{{data.name_cn}}</el-tag>
              <el-tag type="info" v-else-if="data.type === 2">{{MenuType[data.type]}}||{{data.name_cn}}</el-tag>
              <el-tag type="warning" v-else-if="data.type === 3">{{MenuType[data.type]}}||{{data.name_cn}}</el-tag>
              <el-tag type="danger" v-else-if="data.type === 4">{{MenuType[data.type]}}||{{data.name_cn}}</el-tag>
            </div>
          </div>
        </template>
      </el-tree>
...
import { selectListApi, deleteApi, dragApi } from '@/api/unieap/mdm/dic'
