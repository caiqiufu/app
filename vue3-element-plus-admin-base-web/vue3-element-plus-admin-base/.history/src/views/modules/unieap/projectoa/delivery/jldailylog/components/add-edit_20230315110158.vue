...
export default defineComponent({
  ...
  setup(_props, { emit }) {
        ...
        bizHandleApi(params).then(r => {
          if (r) {
            ...
            if (r.data.deliveryBuildingpartList.length === 0) {
              data.form.deliveryBuildingpartList = [{ id: Date.now(), projectId: data.form.projectId, sgbw: '', sglr: '', sgqk: '' }]
            }
          }
        })
      }
    ...
    const addBuildingPart = () => {
      data.form.deliveryBuildingpartList.push({ id: Date.now(), projectId: data.projectId, sgbw: '', sglr: '', sgqk: '' });
    }
