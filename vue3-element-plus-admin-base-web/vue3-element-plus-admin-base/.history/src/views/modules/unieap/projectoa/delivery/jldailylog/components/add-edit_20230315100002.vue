  ...
  setup(_props, { emit }) {
    ...
    const data = reactive({
      ...
      form: {
        ...
        modifyDate: '',
        modifyBy: '',
        deliveryBuildingpartList: [{code: Date.now(), sgbw: '', sglr: '', sgqk: '' }]
      },
      roles: []
    })
    ...
    const init = async (id) => {
      ...
      data.form.deliveryBuildingpartList = [{code: Date.now(), sgbw: '', sglr: '', sgqk: '' }]
      data.visible = true
    }
    ...
    const addBuildingPart = () => {
      data.form.deliveryBuildingpartList.push({code: Date.now(), sgbw: '', sglr: '', sgqk: '' });
    }
