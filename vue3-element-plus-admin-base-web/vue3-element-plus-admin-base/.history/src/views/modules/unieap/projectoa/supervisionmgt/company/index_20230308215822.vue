  ...
  <Container>
    ...
    <template #default>
      <el-table ref="refTable" v-loading="loading" :data="list" @selection-change="selectionHandle"
        ...
        <el-table-column align="center" :label="$t('unieap.projectoa.supervisionmgt.company.corporation')"
          prop="corporation" width="200" sortable='custom' />
...
<style lang="scss" scoped>.el-tag+.el-tag {
  margin-left: 5px;
}</style>
