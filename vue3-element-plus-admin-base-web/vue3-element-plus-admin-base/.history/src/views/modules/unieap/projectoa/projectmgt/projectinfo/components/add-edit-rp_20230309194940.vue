<template>
  <el-dialog width="600px" :title="$t('unieap.comm.edit')" v-model="visible" :close-on-click-modal="false"
    ...
    <el-form v-loading="loading" :model="form" :rules="rules" ref="refForm" label-width="150px" label-position="right">
      ...
      <el-form-item :label="$t('unieap.projectoa.supervisionmgt.company.leaderName')" prop="leaderName">
