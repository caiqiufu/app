<template>
  <el-dialog width="1000px" :title="form.id ? $t('unieap.comm.update') : $t('unieap.comm.create')" v-model="visible"
    ...
    <el-form v-loading="loading" :model="form" :rules="rules" ref="refForm" label-width="120px" label-position="right">
      ...
      <el-divider content-position="left"><font style="font-weight: bold;">天气情况</font></el-divider>
      <el-row>
        <el-col :span="6">
      ...
      <el-divider content-position="left"><font style="font-weight: bold;">施工情况</font></el-divider>
      <el-row>
        ...
        <el-form-item label-width="80px" label="施工内容" prop="sglr">
          <el-input type="textarea" :rows="3" v-model="form.sglr" style="width:260px" />
        </el-form-item>
        <el-form-item label-width="80px" label="施工情况" prop="sgqk">
          <el-input type="textarea" :rows="3" v-model="form.sgqk" style="width:260px" />
        </el-form-item>
      </el-row>
      <el-divider content-position="left"><font style="font-weight: bold;">监理巡检记录</font></el-divider>
      <el-row>
        <el-col :span="12">
          <el-row>
        <el-form-item label="巡检记录" prop="xjjl">
          <el-input type="textarea" :rows="3" v-model="form.xjjl" style="width:260px"/>
        </el-form-item>
      </el-row>
      <el-row>
        <el-form-item label-width="180px" label="旁站项目及旁站记录情况" prop="pzjl">
          <el-input v-model="form.pzjl"  style="width:230px"/>
        </el-form-item>
      </el-row>
      <el-row>
        <el-form-item label-width="180px" label="见证项目及见证记录情况" prop="jzjl">
          <el-input v-model="form.jzjl"  />
        </el-form-item>
      </el-row>
      <el-row>
        <el-form-item label-width="180px" label="隐蔽工程验收情况" prop="ybgcys">
          <el-input v-model="form.ybgcys"  />
        </el-form-item>
      </el-row>
      <el-row>
        <el-form-item label-width="180px" label="分项工程检验批验收情况" prop="fxgcjy">
          <el-input v-model="form.fxgcjy" />
        </el-form-item>
      </el-row>
      <el-row>
        <el-form-item label-width="180px" label="工程（例会）会议情况" prop="gclh">
          <el-input v-model="form.gclh" />
        </el-form-item>
      </el-row>
        </el-col>
        <el-col :span="12">
        ...
        <el-form-item label="施工安全问题及处理后落实情况" prop="aqls">
          <el-input type="textarea" :rows="2" v-model="form.aqls"  />
        </el-form-item>
      </el-row>
      <el-row>
        <el-form-item label="监理书面指令、执行及回复情况" prop="jlzlzx">
          <el-input type="textarea" :rows="2" v-model="form.jlzlzx"  />
        </el-form-item>
      </el-row>
      <el-row>
        <el-form-item label="建设单位口头指示及处理意见" prop="ktzscl">
          <el-input type="textarea" :rows="2" v-model="form.ktzscl"  />
        </el-form-item>
      </el-row>
      <el-row>
        <el-form-item label="施工单位汇报事项及处理意见" prop="hbsxcl">
          <el-input type="textarea" :rows="2" v-model="form.hbsxcl" />
        </el-form-item>
      </el-row>
      </el-col>
      </el-row>
