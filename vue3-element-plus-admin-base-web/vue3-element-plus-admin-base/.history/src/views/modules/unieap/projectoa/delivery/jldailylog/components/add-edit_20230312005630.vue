<template>
  <el-dialog width="800px" :title="form.id ? $t('unieap.comm.update') : $t('unieap.comm.create')" v-model="visible"
    ...
    <el-form v-loading="loading" :model="form" :rules="rules" ref="refForm" label-width="100px" label-position="right">
      ...
      <el-row>
        <el-form-item label-width="180px" label="施工安全问题及处理后落实情况" prop="aqls">
          <el-input type="textarea" :rows="3" v-model="form.aqls" style="width:600px"/>
        </el-form-item>
      </el-row>
      <el-row>
        <el-form-item label-width="180px" label="监理书面指令、执行及回复情况" prop="jlzlzx">
          <el-input type="textarea" :rows="3" v-model="form.jlzlzx" style="width:600px"/>
        </el-form-item>
      </el-row>
      <el-row>
        <el-form-item label-width="180px" label="建设单位口头指示及处理意见" prop="ktzscl">
          <el-input type="textarea" :rows="3" v-model="form.ktzscl" style="width:600px"/>
        </el-form-item>
      </el-row>
      <el-row>
        <el-form-item label-width="180px" label="施工单位汇报事项及处理意见" prop="hbsxcl">
      ...
      <el-row>
        <el-form-item label="总监理工程师意见" prop="zjlyj">
          <el-input type="textarea" :rows="10" v-model="form.zjlyj" style="width:600px"/>
        </el-form-item>
      </el-row>
