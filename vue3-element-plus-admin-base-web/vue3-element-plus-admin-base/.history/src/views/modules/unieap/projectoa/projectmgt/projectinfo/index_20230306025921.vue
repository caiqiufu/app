  ...
  <Container>
        ...
        <el-row :gutter="5" type="flex" justify="center">
          <el-col :span="15">
            <el-form-item>
              ...
              <el-button v-permission="'projectmgt.projectinfo:viewdetail'" type="primary"
                :disabled="selection.length != 1" @click="deleteHandle()">
    ...
    <template #default>
      <el-table ref="refTable" v-loading="loading" :data="list" @selection-change="selectionHandle"
        ...
        <el-table-column align="center" :label="$t('unieap.projectoa.projectmgt.projectinfo.duration')" prop="duration" />
