<template>
  <el-dialog width="1200px" :title="form.id ? $t('unieap.comm.update') : $t('unieap.comm.create')" v-model="visible"
    ...
    <el-form v-loading="loading" :model="form" :rules="rules" ref="refForm" label-width="120px" label-position="right">
      ...
      <el-row>
        ...
        <el-form-item label-width="80px" label="施工内容" prop="sglr">
          <el-input type="textarea" :rows="3" v-model="form.sglr" style="width:300px" />
        </el-form-item>
        <el-form-item label-width="80px" label="施工情况" prop="sgqk">
          <el-input type="textarea" :rows="3" v-model="form.sgqk" style="width:300px" />
        </el-form-item>
      </el-row>
      ...
      <el-row>
        ...
        <el-form-item label="巡检记录" prop="xjjl">
          <el-input type="textarea" :rows="3" v-model="form.xjjl" />
        </el-form-item>
      </el-row>
      <el-row>
        <el-form-item label-width="180px" label="旁站项目及旁站记录情况" prop="pzjl">
          <el-input v-model="form.pzjl"  />
        </el-form-item>
      </el-row>
      <el-row>
