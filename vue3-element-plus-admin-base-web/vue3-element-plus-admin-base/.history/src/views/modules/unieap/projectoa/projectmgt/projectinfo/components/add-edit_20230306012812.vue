  ...
  setup(_props, { emit }) {
    ...
    const rules = computed(() => {
      return {
        ...
        name: [{ required: true, message: [t('unieap.comm.plsInput')] + [t('unieap.projectoa.comm.projectType')], trigger: 'blur' }],
        type: [{ required: false, message: [t('unieap.comm.plsInput')] + [t('unieap.projectoa.projectmgt.projectinfo.jzmj')], validator: isNumber, trigger: 'blur' }],
