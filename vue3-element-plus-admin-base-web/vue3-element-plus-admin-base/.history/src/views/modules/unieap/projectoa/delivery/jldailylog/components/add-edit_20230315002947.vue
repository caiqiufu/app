  ...
  <el-dialog width="1000px" :title="form.id ? $t('unieap.comm.update') : $t('unieap.comm.create')" v-model="visible"
    ...
    <el-form v-loading="loading" :model="form" :rules="rules" ref="refForm" label-width="120px" label-position="right">
      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item v-for="(clueInfo, index) in form.buildingPartList"
          :label="$t('unieap.bakerstreet.scriptmgt.clueChapterName') + (index + 1)" :key="clueInfo.sgbw">
          <el-input v-model="clueInfo.sgbw" :placeholder="$t('unieap.bakerstreet.scriptmgt.clueChapterName')"
