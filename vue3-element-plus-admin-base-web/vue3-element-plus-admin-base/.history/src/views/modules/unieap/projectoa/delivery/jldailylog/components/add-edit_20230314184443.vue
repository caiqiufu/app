<template>
  <el-dialog width="800px" :title="form.id ? $t('unieap.comm.update') : $t('unieap.comm.create')" v-model="visible"
    ...
    <el-form v-loading="loading" :model="form" :rules="rules" ref="refForm" label-width="120px" label-position="right">
      <el-row>
        <el-form-item label-width="80px" style="width:150px" :label="$t('unieap.projectoa.comm.projectName')" prop="projectName">
        ...
        <el-form-item label-width="80px" style="width:150px" :label="$t('unieap.projectoa.comm.sgdw')" prop="sgdw">
          <el-input disabled v-model="form.sgdw" />
        </el-form-item>
        <el-form-item label-width="80px" style="width:150px" label="日期" prop="logTime">
