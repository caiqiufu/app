    ...
    <template #header>
      <el-form ref="refForm" :inline="true" @keyup.enter="reacquireHandle()">
        <el-row>
          ...
          <el-form-item :label="$t('unieap.comm.dateStart')" prop="dateStart">
            <el-date-picker v-model="form.dateStart" type="date" :placeholder="$t('unieap.comm.plsSelect')">
            </el-date-picker>
          </el-form-item>
          <el-form-item :label="$t('unieap.comm.dateEnd')" prop="dateEnd">
            <el-date-picker v-model="form.dateEnd" type="date" :placeholder="$t('unieap.comm.plsSelect')">
            </el-date-picker>
          </el-form-item>
  ...
  setup() {
    ...
    const getList = () => {
      const params = {
        ...
        dateStart: parseDate2Str(data.form.dateStart),
        dateEnd: parseDate2Str(data.form.dateEnd)
      }
      data.loading = true
