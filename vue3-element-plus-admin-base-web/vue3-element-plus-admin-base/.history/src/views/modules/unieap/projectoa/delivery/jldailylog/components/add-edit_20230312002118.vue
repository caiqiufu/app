    ...
    <el-form v-loading="loading" :model="form" :rules="rules" ref="refForm" label-width="150px" label-position="right">
      ...
      <el-row>
        <el-form-item :label="$t('unieap.projectoa.comm.sgdw')" prop="sgdw">
          <el-input v-model="form.sgdw" style="width:200px" disabled />
        </el-form-item>
      </el-row>
      ...
      <el-form-item :label="$t('unieap.projectoa.supervisionmgt.company.type')" prop="type">
      ...
      <el-form-item :label="$t('unieap.projectoa.supervisionmgt.company.businessCorporation')" prop="businessCorporation">
        <el-input v-model="form.businessCorporation" :placeholder="$t('unieap.comm.plsInput')" maxlength="32"
          style="width:300px" />
      </el-form-item>
      <el-form-item :label="$t('unieap.projectoa.supervisionmgt.company.businessLicense')" prop="businessLicense">
        <el-input v-model="form.businessLicense" :placeholder="$t('unieap.comm.plsInput')" maxlength="32" show-word-limit
          style="width:300px" />
      </el-form-item>
      <el-form-item :label="$t('unieap.projectoa.supervisionmgt.company.address')" prop="address">
        <el-input type="textarea" :rows="3" v-model="form.address" :placeholder="$t('unieap.comm.plsInput')"
          style="width:300px" />
      </el-form-item>
