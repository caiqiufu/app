<template>
  <el-dialog width="600px" :title="$t('unieap.comm.edit')" v-model="visible"
    ...
    <el-form v-loading="loading" :model="form" :rules="rules" ref="refForm" label-width="150px" label-position="right">
      ...
      <el-form-item v-if="addVisible" :label="$t('unieap.projectoa.supervisionmgt.company.companyName')" prop="companyName">
        <el-select  v-model="form.jsdw.companyName" :placeholder="$t('unieap.comm.plsSelect')" style="width:300px">
          <el-option v-for="item in optionsProject" :key="item.dicCode" :label="item.dicName" :value="item.dicCode">
          </el-option>
        </el-select>      
      </el-form-item>
      <el-form-item  v-else :label="$t('unieap.projectoa.supervisionmgt.company.companyName')" prop="companyName">
        <el-input v-model="form.jsdw.companyName" :placeholder="$t('unieap.comm.plsInput')" maxlength="32"
          style="width:300px"/>
      </el-form-item>
      <el-form-item  v-else :label="$t('unieap.projectoa.supervisionmgt.company.leaderName')" prop="leaderName">
        <el-input v-model="form.jsdw.leaderName" :placeholder="$t('unieap.comm.plsInput')" maxlength="32"
          style="width:300px"/>
      </el-form-item>
      <el-form-item  v-else :label="$t('unieap.projectoa.supervisionmgt.employee.phone')" prop="phone">
        <el-input v-model="form.jsdw.phone" :placeholder="$t('unieap.comm.plsInput')" maxlength="32"
          style="width:300px"/>
      </el-form-item>
      <el-form-item :label="$t('unieap.projectoa.projectmgt.projectinfo.jzmj')" prop="jzmj">
        <el-input v-model="form.jzmj" :placeholder="$t('unieap.comm.plsInput')" maxlength="32" style="width:300px" />
