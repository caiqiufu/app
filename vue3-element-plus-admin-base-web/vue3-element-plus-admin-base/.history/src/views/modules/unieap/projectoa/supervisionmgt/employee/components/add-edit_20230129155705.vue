  ...
  <el-dialog width="600px" :title="form.id ? $t('unieap.comm.update') : $t('unieap.comm.create')" v-model="visible"
    ...
    <el-form v-loading="loading" :model="form" :rules="rules" ref="refForm" label-width="150px" label-position="right">
      <el-form-item :label="$t('unieap.projectoa.supervisionmgt.company.companyName')" prop="companyId">
        <el-select v-model="form.companyId" :placeholder="$t('unieap.comm.plsSelect')" style="width:300px">
          <el-option v-for="item in optionsCompanys" :key="item.dicCode" :label="item.dicName" :value="item.dicCode">
          </el-option>
        </el-select>
      </el-form-item>
      ...
      <el-form-item :label="$t('unieap.projectoa.supervisionmgt.employee.type')" prop="type">
        <el-select v-model="form.type" :placeholder="$t('unieap.comm.plsSelect')" style="width:300px">
          <el-option v-for="item in optionsCompanyType" :key="item.dicCode" :label="item.dicName" :value="item.dicCode">
          </el-option>
        </el-select>
      </el-form-item>
      ...
      <el-form-item :label="$t('unieap.projectoa.supervisionmgt.employee.phoneNumber')" prop="phoneNumber">
        <el-input v-model="form.phoneNumber" :placeholder="$t('unieap.comm.plsInput')" maxlength="32" show-word-limit
          style="width:300px" />
      </el-form-item>
      ...
      <el-form-item :label="$t('unieap.projectoa.supervisionmgt.employee.license')" prop="license">
        <el-input v-model="form.license" :placeholder="$t('unieap.comm.plsInput')" maxlength="32" show-word-limit
          style="width:300px" />
      </el-form-item>
      <el-form-item :label="$t('unieap.projectoa.supervisionmgt.employee.licenseNumber')" prop="licenseNumber">
        <el-input v-model="form.licenseNumber" :placeholder="$t('unieap.comm.plsInput')" maxlength="32" show-word-limit
          style="width:300px" />
      </el-form-item>
