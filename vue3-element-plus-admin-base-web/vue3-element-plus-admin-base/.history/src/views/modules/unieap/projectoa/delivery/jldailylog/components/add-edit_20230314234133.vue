    ...
    <el-form v-loading="loading" :model="form" :rules="rules" ref="refForm" label-width="120px" label-position="right">
      ...
      <el-row>
        ...
        <el-form-item label="施工安全问题及处理后落实情况" prop="aqls">
          <el-input type="textarea" :rows="2" v-model="form.aqls"   style="width:220px"/>
        </el-form-item>
      </el-row>
      <el-row>
        <el-form-item label="监理书面指令、执行及回复情况" prop="jlzlzx">
          <el-input type="textarea" :rows="2" v-model="form.jlzlzx"   style="width:220px"/>
        </el-form-item>
      </el-row>
      <el-row>
        <el-form-item label="建设单位口头指示及处理意见" prop="ktzscl">
          <el-input type="textarea" :rows="2" v-model="form.ktzscl"   style="width:220px"/>
        </el-form-item>
      </el-row>
      <el-row>
