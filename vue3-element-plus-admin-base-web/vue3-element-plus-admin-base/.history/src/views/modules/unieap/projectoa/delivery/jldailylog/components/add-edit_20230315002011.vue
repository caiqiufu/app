<template>
  <el-dialog width="1000px" :title="form.id ? $t('unieap.comm.update') : $t('unieap.comm.create')" v-model="visible"
    ...
    <el-form v-loading="loading" :model="form" :rules="rules" ref="refForm" label-width="120px" label-position="right">
      ...
      <el-row>
        <el-col :span="8">
          <el-form-item v-for="(buildingPartInfo, index) in form.buildingPartList" label-width="80px"
            :label="施工部位 + (index + 1)" :key="buildingPartInfo.sgbw">
        ...
        <el-col :span="8">
          <el-form-item v-for="(buildingPartInfo, index) in form.buildingPartList" label-width="80px"
            :label="施工内容 + (index + 1)" :key="buildingPartInfo.sglr">
            <el-input type="textarea" :rows="1" v-model="buildingPartInfo.sglr" style="width:230px" />
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item v-for="(buildingPartInfo, index) in form.buildingPartList" label-width="80px"
            :label="施工情况 + (index + 1)" :key="buildingPartInfo.sgqk">
      ...
      <el-row v-for="(buildingPartInfo, index) in form.buildingPartList">
        <el-form-item label-width="80px" :label="施工部位 + (index + 1)" :key="index">
          <el-select filterable allow-create v-model="buildingPartInfo.sgbw" style="width:200px"
            :placeholder="$t('unieap.comm.plsSelect')">
            <el-option v-for="item in optionsBuildingPartList" :key="item.dicCode" :label="item.dicName"
              :value="item.dicCode">
        ...
        <el-form-item label-width="80px" :label="施工内容 + (index + 1)" :key="index">
          <el-input type="textarea" :rows="1" v-model="buildingPartInfo.sglr" style="width:230px" />
        </el-form-item>
        <el-form-item label-width="80px" :label="施工情况 + (index + 1)" :key="index">
          <el-input type="textarea" :rows="1" v-model="buildingPartInfo.sgqk" style="width:230px" />
        </el-form-item>
...
export default defineComponent({
  ...
  setup(_props, { emit }) {
    ...
    const init = async (id) => {
      ...
      data.form.buildingPartList = [{ sgbw: '', sglr: '', sgqk: '' }, { sgbw: '', sglr: '', sgqk: '' }]
      data.visible = true
    }
