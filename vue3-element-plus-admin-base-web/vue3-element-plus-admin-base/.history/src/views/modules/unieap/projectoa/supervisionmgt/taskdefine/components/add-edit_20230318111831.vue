  ...
  setup(_props, { emit }) {
    ...
    const rules = computed(() => {
      return {
        ...
        notifyFlag: [{ required: true, message: [t('unieap.comm.plsInput')] + [t('unieap.projectoa.supervisionmgt.company.businessCorporation')], trigger: 'blur' }],
        notifyCron: [{ required: true, message: [t('unieap.comm.plsInput')] + [t('unieap.projectoa.supervisionmgt.company.businessLicense')], trigger: 'blur' }]
      }
    })
    /**
     * @description: 加载窗口初始化
