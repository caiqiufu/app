...
@Table(name = "projectoa_building_part")
public class BuildingPart implements Serializable {
	...
	@Column(nullable = false, length = 512, columnDefinition = "varchar(512) COMMENT '名称'")
	private String name;
