...
@Table(name = "school_weeking_plan")
public class WeekingPlan implements Serializable {
	...
	@Column(nullable = false, length = 32, columnDefinition = "varchar(32) COMMENT '年级编码'")
	private String code;
	
	@Column(nullable = false, length = 16, columnDefinition = "BIGINT(20) COMMENT '年级 Grade ID'")
	private Long gradeId;
	
	@Column(nullable = false, length = 16, columnDefinition = "BIGINT(20) COMMENT '班级 Class ID'")
	private Long classId;
	
	@Column(nullable = true, length = 32, columnDefinition = "varchar(32) COMMENT '日期'")
	private String month;
	
	@Column(nullable = true, length = 32, columnDefinition = "varchar(32) COMMENT '周，2022-12-05 至 2022-12-11(第1周)'")
	private String week;
