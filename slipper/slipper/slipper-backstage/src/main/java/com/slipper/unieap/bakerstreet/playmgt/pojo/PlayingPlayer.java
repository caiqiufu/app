...
@Table(name = "bakerstreet_playing_player")
public class PlayingPlayer implements Serializable {
	...
	@Column(nullable = false, length = 16, columnDefinition = "BIGINT(16) COMMENT '玩家ID'")
	private Long playerId;
	
	@Column(nullable = false, length = 16, columnDefinition = "BIGINT(16) COMMENT '房间ID'")
	private Long roomId;
