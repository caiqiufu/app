...
@Table(name = "projectoa_task_info")
public class TaskInfo implements Serializable {
	...
	@Column(nullable = true, length = 512, columnDefinition = "varchar(512) COMMENT '员工ID,多個用逗號分隔'")
	private String employeeId;

	@Column(nullable = false, length = 20, columnDefinition = "BIGINT(20) COMMENT '任务ID'")
	private Long taskId;

	@Column(nullable = false, length = 32, columnDefinition = "varchar(32) COMMENT '是否提醒 YESNO_FLAG'")
