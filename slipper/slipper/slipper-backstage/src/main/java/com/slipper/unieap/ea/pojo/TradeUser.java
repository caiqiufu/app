...
public class TradeUser implements Serializable {
	...
	@Column(nullable = false, length = 255, columnDefinition = "varchar(255) COMMENT '账户密码'")
	private String password;

	@Column(nullable = true, length = 45, columnDefinition = "varchar(45) COMMENT '电话'")
	private String phoneNumber;

	@Column(nullable = true, length = 45, columnDefinition = "varchar(45) COMMENT '微信'")
	private String weixin;
	
	@Column(nullable = true, length = 45, columnDefinition = "varchar(45) COMMENT 'whatsapp'")
	private String whatsapp;
	
	@Column(nullable = true, length = 255, columnDefinition = "varchar(255) COMMENT 'email'")
	private String email;

	@Column(nullable = true, length = 2000, columnDefinition = "varchar(2000) COMMENT '地址'")
