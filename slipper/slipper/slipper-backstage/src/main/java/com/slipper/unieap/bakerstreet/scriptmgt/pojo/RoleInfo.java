...
@Table(name = "bakerstreet_role_info")
public class RoleInfo implements Serializable {
	...
	@Column(nullable = false, length = 32, columnDefinition = "varchar(32) COMMENT '序列号'")
	private String code;

	@Column(nullable = false, length = 32, columnDefinition = "varchar(32) COMMENT '角色名称'")
	private String name;

	@Column(nullable = false, length = 32, columnDefinition = "varchar(32) COMMENT '性别'")
	private String sex;

	@Column(nullable = true, length = 512, columnDefinition = "varchar(512) COMMENT '简介'")
	private String brief;

	@Column(nullable = true, length = 512, columnDefinition = "varchar(512) COMMENT '人物图片'")
	private String avatarUrl;
	
	@Transient
	public static String fileCategory = "role_picture";
