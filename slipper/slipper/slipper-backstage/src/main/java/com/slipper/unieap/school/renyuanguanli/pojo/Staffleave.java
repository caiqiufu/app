...
public class Staffleave implements Serializable {
	...
	@Column(nullable = false, length = 16, columnDefinition = "BIGINT(20) COMMENT 'staff ID'")
	private Long staffId;

	@Temporal(TemporalType.DATE)
	@Column(nullable = false, columnDefinition = "DATETIME COMMENT '离职时间'")
	private Date leaveDate;
	
	@Column(nullable = false, length = 32, columnDefinition = "varchar(32) COMMENT '离职原因,工作琐碎没有发展,工资待遇不满意,家庭原因,被解雇,其他'")
