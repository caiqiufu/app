...
public class ClassInfo implements Serializable {
	...
	@Column(nullable = false, length = 32, columnDefinition = "varchar(32) COMMENT '班级名称'")
	private String name;

	@Column(nullable = false, length = 16, columnDefinition = "BIGINT(20) COMMENT '年级 Grade ID'")
	private Long gradeId;

	@Column(nullable = false, length = 1, columnDefinition = "varchar(1) COMMENT '是否毕业:Y:毕业,N:正常'")
