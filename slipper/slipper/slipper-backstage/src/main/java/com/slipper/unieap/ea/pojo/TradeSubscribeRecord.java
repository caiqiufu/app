...
@Table(name = "trade_subscribe_record")
public class TradeSubscribeRecord implements Serializable {
	...
	@Column(nullable = false, length = 45, columnDefinition = "varchar(45) COMMENT '订阅标记'")
	...
	@Temporal(TemporalType.TIMESTAMP)
	@Column(nullable = true, columnDefinition = "DATETIME COMMENT '订阅结束时间'")
