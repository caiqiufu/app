...
@Table(name = "bakerstreet_picture_info")
public class PictureInfo implements Serializable {
	...
	@Column(nullable = false, length = 16, columnDefinition = "BIGINT(16) COMMENT 'biz ID'")
	private Long bizId;
	
	@Column(nullable = true, length = 32, columnDefinition = "varchar(32) COMMENT '业务类型'")
	private String bizType;

	@Column(nullable = true, length = 16, columnDefinition = "BIGINT(16) COMMENT 'file ID'")
	private Long fileId;

	@Column(nullable = true, length = 512, columnDefinition = "varchar(512) COMMENT '图片地址'")
	private String url;
	
	@Column(nullable = true, length = 32, columnDefinition = "varchar(32) COMMENT '名称'")
	private String name;

	@Column(nullable = true, length = 32, columnDefinition = "varchar(32) COMMENT '序列'")
	private String seq;
