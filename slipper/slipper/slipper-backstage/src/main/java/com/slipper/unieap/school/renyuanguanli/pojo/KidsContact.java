...
@Table(name = "school_kids_contact")
public class KidsContact implements Serializable {
	...
	@Column(nullable = false, length = 16, columnDefinition = "BIGINT(20) COMMENT 'kids ID'")
	private Long kidsId;
	
	@Column(nullable = false, length = 16, columnDefinition = "BIGINT(20) COMMENT 'contact ID'")
	private Long contactId;
	
	@Column(nullable = false, length = 32, columnDefinition = "varchar(32) COMMENT '联系人优先顺序'")
	private String priority;
	
	@Column(nullable = false, length = 32, columnDefinition = "varchar(32) COMMENT '关系，爸爸，妈妈，爷爷，奶奶，外公，外婆，其他'")
