...
@Table(name = "school_bind_timecard")
public class BindTimecard implements Serializable {
	...
	@Column(nullable = false, length = 16, columnDefinition = "BIGINT(20) COMMENT 'bind ID,如KidsId,staffId'")
	private Long bindId;
	
	@Column(nullable = false, length = 32, columnDefinition = "varchar(32) COMMENT 'timecard 编号'")
