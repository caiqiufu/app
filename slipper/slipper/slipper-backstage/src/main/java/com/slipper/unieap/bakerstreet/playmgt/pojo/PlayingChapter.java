...
@Table(name = "bakerstreet_playing_chapter")
public class PlayingChapter implements Serializable {
	...
	@Column(nullable = true, length = 16, columnDefinition = "BIGINT(16) COMMENT '剧本幕Id'")
