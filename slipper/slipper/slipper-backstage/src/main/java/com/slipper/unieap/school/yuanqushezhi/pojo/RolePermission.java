...
@Table(name = "school_role_permission")
public class RolePermission implements Serializable {
	...
	@Column(nullable = false, length = 16, columnDefinition = "BIGINT(20) COMMENT '角色 Role ID'")
	private Long roleId;
	
	@Column(nullable = false, length = 16, columnDefinition = "BIGINT(20) COMMENT '权限  Menu ID'")
