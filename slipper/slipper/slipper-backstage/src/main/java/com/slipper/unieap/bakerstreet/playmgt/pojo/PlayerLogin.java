...
@Table(name = "bakerstreet_player_login")
public class PlayerLogin implements Serializable {
	...
	@Column(nullable = true, length = 32, columnDefinition = "varchar(32) COMMENT '玩家ID'")
	private String playerId;

	@Column(nullable = true, length = 32, columnDefinition = "varchar(32) COMMENT 'wxau Id'")
	private String wxauId;
	
	@Column(nullable = true, length = 32, columnDefinition = "varchar(32) COMMENT 'session key'")
