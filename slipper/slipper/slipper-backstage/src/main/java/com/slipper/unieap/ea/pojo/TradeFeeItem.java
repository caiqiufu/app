...
@Table(name = "trade_fee_item")
public class TradeFeeItem implements Serializable {
	...
	@Column(nullable = true, length = 45, columnDefinition = "varchar(45) COMMENT '费用层级1:用户级,2:账户级'")
	private String feeLevel;

	@Column(nullable = false, length = 45, columnDefinition = "varchar(45) COMMENT '费用类型'")
	private String feeType;

	@Column(nullable = false, length = 255, columnDefinition = "varchar(255) COMMENT '费用描述'")
	private String feeDesc;

	@Column(nullable = false, columnDefinition = "double COMMENT '费用金额'")
	private double feeAmount;

	@Column(nullable = false, length = 45, columnDefinition = "varchar(45) COMMENT '费用金额类型1:金额2:百分比'")
