...
@Table(name = "bakerstreet_playing_clue")
public class PlayingClue implements Serializable {
	...
	@Column(nullable = true, length = 16, columnDefinition = "BIGINT(16) COMMENT 'playing Id'")
