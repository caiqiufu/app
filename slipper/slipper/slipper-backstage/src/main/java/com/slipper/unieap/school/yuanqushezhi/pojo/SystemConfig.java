...
@Table(name = "school_system_config")
public class SystemConfig implements Serializable {
	...
	@Column(nullable = false, length = 32, columnDefinition = "varchar(32) COMMENT '参数类型,B:基础设置,A:审核设置,APP:APP权限设置'")
	private String type;
	
	@Column(nullable = false, length = 32, columnDefinition = "varchar(32) COMMENT '参数名称'")
	private String name;
	
	@Column(nullable = true, length = 255, columnDefinition = "varchar(32) COMMENT '参数值'")
