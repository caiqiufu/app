...
@Table(name = "bakerstreet_tag_info")
public class TagInfo implements Serializable {
	...
	@Column(nullable = false, length = 32, columnDefinition = "varchar(32) COMMENT '线索幕大类名称'")
	private String name;

	@Column(nullable = false, length = 512, columnDefinition = "varchar(512) COMMENT '类别，多个逗号分割'")
	private String kinds;

	@Column(nullable = false, length = 32, columnDefinition = "varchar(32) COMMENT '序列'")
	private String seq;
