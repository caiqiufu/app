...
@Table(name = "bakerstreet_chapter_info")
public class ChapterInfo implements Serializable {
	...
	@Column(nullable = false, length = 16, columnDefinition = "BIGINT(16) COMMENT '剧本ID'")
	private Long scriptId;
	
	@Column(nullable = false, length = 16, columnDefinition = "BIGINT(16) COMMENT '角色ID'")
	private Long roleId;
	
	@Column(nullable = false, length = 32, columnDefinition = "varchar(32) COMMENT '章节序号'")
	private String chapterNumber;
	
	@Column(nullable = true, length = 32, columnDefinition = "varchar(32) COMMENT '章节名称'")
	private String code;
	
	@Column(nullable = true, length = 32, columnDefinition = "varchar(32) COMMENT '章节名称'")
	private String name;
	
	@Column(nullable = true, length = 512, columnDefinition = "varchar(512) COMMENT '简介'")
	private String brief ;
	
	@Transient
	public static String fileCategory = "chapter_picture";
	
	//该章节下的内容就是多张有顺序的图片,图片分类名称为chapter_picture
