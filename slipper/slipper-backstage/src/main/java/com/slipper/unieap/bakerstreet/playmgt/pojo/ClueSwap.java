...
@Table(name = "bakerstreet_clue_swap")
public class ClueSwap implements Serializable {
	...
	@Column(nullable = true, length = 16, columnDefinition = "BIGINT(16) COMMENT '发送剧本玩家ID'")
	private Long giverId;

	@Column(nullable = true, length = 16, columnDefinition = "BIGINT(16) COMMENT '接收剧本玩家ID'")
	private Long receiverId;

	@Column(nullable = true, length = 16, columnDefinition = "BIGINT(16) COMMENT '线索幕'")
	private Long clueId;

	@Column(nullable = true, length = 16, columnDefinition = "BIGINT(16) COMMENT '线索幕明细'")
	private Long clueDetailId;
