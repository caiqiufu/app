...
@Table(name = "projectoa_field_defaultvalue")
public class FieldDefaultvalue implements Serializable {
	...
	@Column(nullable = false, length = 512, columnDefinition = "varchar(512) COMMENT '字段名称'")
	private String fieldName;

	/**
	 * 模板中的参数采用{}标识，在保存数据时去掉{}
	 */
	@Column(nullable = true, length = 4000, columnDefinition = "varchar(4000) COMMENT '字段值模板'")
