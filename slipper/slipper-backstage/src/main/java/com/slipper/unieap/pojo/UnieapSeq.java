...
@Table(name = "unieap_seq")
public class UnieapSeq implements Serializable {
	...
	@Column(nullable = false, length = 32, columnDefinition = "varchar(32) COMMENT '序列名称'")
	private String seqName;

	@Column(nullable = false, length = 32, columnDefinition = "varchar(32) COMMENT '序列值'")
	private Long val;
	@Column(nullable = false, length = 32, columnDefinition = "INTEGER(20) COMMENT '序列跳次'")
