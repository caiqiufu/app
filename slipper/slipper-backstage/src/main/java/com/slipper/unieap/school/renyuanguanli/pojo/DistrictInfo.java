...
@Table(name = "school_district_info")
public class DistrictInfo implements Serializable {
	...
	@Column(nullable = false, length = 16, columnDefinition = "BIGINT(20) COMMENT 'parent id'")
	private Long parentId;

	@Column(nullable = false, length = 32, columnDefinition = "varchar(32) COMMENT '地址信息'")
	private String district;

	@Column(nullable = false, length = 8, columnDefinition = "varchar(32) COMMENT '层级'")
