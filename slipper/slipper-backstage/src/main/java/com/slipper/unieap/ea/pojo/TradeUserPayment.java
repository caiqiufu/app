...
@Table(name = "trade_user_payment")
public class TradeUserPayment implements Serializable {
	...
	@Column(nullable = false, length = 16, columnDefinition = "BIGINT(20) COMMENT 'ID'")
	private Long billId;

	@Column(nullable = true, length = 45, columnDefinition = "varchar(45) COMMENT '用户编码'")
	private String userCode;
	
	@Column(nullable = true, length = 45, columnDefinition = "varchar(45) COMMENT '账户'")
	private String accountCode;
	
	@Column(nullable = false, columnDefinition = "double COMMENT '支付金额'")
	private double payAmount;

	@Column(nullable = false, length = 45, columnDefinition = "varchar(45) COMMENT 'BT:银行转账,WX:微信,ZFB:支付宝'")
	private String payMethod;

	@Column(nullable = false, columnDefinition = "DATETIME COMMENT '支付日期'")
	private Date payDate;

	@Column(nullable = true, length = 255, columnDefinition = "varchar(255) COMMENT '支付人名称名称'")
	private String userName;

	@Column(nullable = true, length = 255, columnDefinition = "varchar(255) COMMENT '支付账号'")
	private String accountNo;
	
	@Column(nullable = true, length = 255, columnDefinition = "varchar(255) COMMENT '支付截图'")
