...
@Table(name = "unieap_task_config")

public class UnieapTaskConfig implements Serializable {
	...
	@Column(nullable = true, length = 512, columnDefinition = "varchar(512) COMMENT 'class name'")
	private String className;

	@Column(nullable = true, length = 512, columnDefinition = "varchar(512) COMMENT 'service name'")
	private String handlerName;

	@Temporal(TemporalType.TIMESTAMP)
	@Column(nullable = false, columnDefinition = "DATETIME COMMENT '生效时间'")
	private Date effectiveTime;

	@Column(nullable = true, length = 32, columnDefinition = "varchar(32) COMMENT '重试次数'")
	private int retryTimes;

	@Column(nullable = true, length = 32, columnDefinition = "varchar(32) COMMENT '任务描述'")
	private String taskDesc;

	@Column(nullable = false, length = 32, columnDefinition = "varchar(32) COMMENT '任务类型，unieap_common,unieap_web'")
