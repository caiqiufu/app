...
@Table(name = "school_staff_relation")
public class StaffRelation implements Serializable {
	...
	@Column(nullable = false, length = 16, columnDefinition = "BIGINT(20) COMMENT '班级'")
	private Long classId;

	@Column(nullable = false, length = 16, columnDefinition = "varchar(32) COMMENT 'staffId ID'")
	private Long staffId;

	@Column(nullable = false, length = 32, columnDefinition = "varchar(32) COMMENT '员工类型，MT:主任老师,NU:保育员,AT:配班老师,OT:普通老师'")
