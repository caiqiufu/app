...
@Table(name = "unieap_handler_config")

public class UnieapHandlerConfig implements Serializable {
	...
	@Column(nullable = false, length = 512, columnDefinition = "varchar(512) COMMENT '类型，unieap_common,unieap_web'")
	...
	@Column(nullable = false, length = 8, columnDefinition = "varchar(8) COMMENT '顺序'")
	private int seq;
