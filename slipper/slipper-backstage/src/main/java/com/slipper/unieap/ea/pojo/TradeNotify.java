...
public class TradeNotify implements Serializable {
	...
	@Column(nullable = false, length = 45, columnDefinition = "varchar(45) COMMENT 'T:交易,H:H策略,D:D策略'")
	private String notifyType;

	@Column(nullable = false, length = 45, columnDefinition = "varchar(45) COMMENT 'Notify ID'")
	private String notifyId;

	@Column(nullable = false, length = 2000, columnDefinition = "varchar(2000) COMMENT '提醒内容'")
	private String notifyContent;

	@Column(nullable = true, length = 45, columnDefinition = "varchar(45) COMMENT '账户'")
	private String accountCode;

	@Column(nullable = true, length = 45, columnDefinition = "varchar(45) COMMENT '邮件醒状态1:NEW,2:已发送'")
	private String emailStatus;

	@Column(nullable = true, length = 45, columnDefinition = "varchar(45) COMMENT '短信醒状态1:NEW,2:已发送'")
