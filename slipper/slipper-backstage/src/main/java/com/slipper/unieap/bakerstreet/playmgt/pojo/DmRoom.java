...
@Table(name = "bakerstreet_dm_room")
public class DmRoom implements Serializable {
	...
	@Column(nullable = true, length = 16, columnDefinition = "BIGINT(16) COMMENT 'DM玩家ID'")
	private Long playerId;
	
	@Column(nullable = true, length = 16, columnDefinition = "BIGINT(16) COMMENT '剧本ID'")
	private Long scriptId;
	
	@Column(nullable = true, length = 32, columnDefinition = "varchar(32) COMMENT '房间名称'")
	private String roomName;
	
	@Column(nullable = true, length = 32, columnDefinition = "varchar(32) COMMENT '房间状态,0:等待玩家加入,1:进行中,2:已结束'")
	private String status;
	
	@Column(nullable = true, length = 32, columnDefinition = "varchar(32) COMMENT '房间密码'")
	private String password;
	
	@Column(nullable = true, columnDefinition = "DATETIME COMMENT '开房时间'")
