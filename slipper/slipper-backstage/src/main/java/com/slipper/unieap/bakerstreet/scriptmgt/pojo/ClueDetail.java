...
@Table(name = "bakerstreet_clue_detail")
public class ClueDetail implements Serializable {
	...
	@Column(nullable = true, length = 16, columnDefinition = "BIGINT(16) COMMENT '线索幕ID'")
	private Long clueId;

	@Column(nullable = false, length = 32, columnDefinition = "varchar(32) COMMENT '编码'")
	private String code;

	@Column(nullable = false, length = 32, columnDefinition = "varchar(32) COMMENT '名称'")
	private String name;
	...
	@Transient
	public static String fileCategory = "clue_picture";

	// 该线索下的内容就是有一张顺序的图片,图片分类名称为clue_picture
