...
@Table(name = "projectoa_approve_log")
...
public class ApproveLog implements Serializable {
	...
	@Column(nullable = false, length = 512, columnDefinition = "varchar(512) COMMENT '审核结果'")
	private String approveResult;
	
	@Column(nullable = false, length = 512, columnDefinition = "varchar(512) COMMENT '审核意见'")
	private String approveComment;

	@Transient
	private String approveResultDesc;
	
	public String getAapproveResultDesc() {
		this.approveResultDesc = UnieapConstants.getDicData("JLLOG_STATUS", approveResult).getDicName();
