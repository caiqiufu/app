...
@Table(name = "projectoa_project_company")
public class ProjectCompany implements Serializable {
	...
	@Column(nullable = false, length = 32, columnDefinition = "varchar(32) COMMENT '项目岗位类型 EMPLOYEE_POSITION,1:工程师,2:项目经理,3:项目负责人'")
	private String projectPosition;
	
	@Column(nullable = true, length = 32, columnDefinition = "varchar(32) COMMENT '角色'")
