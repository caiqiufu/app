...
@Table(name = "school_address_info")
public class AddressInfo implements Serializable {
	...
	@Column(nullable = false, length = 16, columnDefinition = "BIGINT(20) COMMENT '关联 ID,如KidsId,staffId'")
	private Long refId;

	@Column(nullable = false, length = 16, columnDefinition = "BIGINT(20) COMMENT '省'")
	private Long provinceId;

	@Column(nullable = false, length = 16, columnDefinition = "BIGINT(20) COMMENT '市'")
	private Long cityId;

	@Column(nullable = false, length = 16, columnDefinition = "BIGINT(20) COMMENT '县，街道'")
	private Long streetId;

	@Column(nullable = true, length = 255, columnDefinition = "varchar(32) COMMENT '详细地址'")
