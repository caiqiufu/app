...
@Table(name = "projectoa_company_info", uniqueConstraints = {
...
public class CompanyInfo implements Serializable {
	...
	@Column(nullable = false, length = 32, columnDefinition = "varchar(32) COMMENT '公司名称'")
	private String name;

	@Column(nullable = false, length = 32, columnDefinition = "varchar(32) COMMENT '单位类型 COMPANY_TYPE,1:建设单位,2:勘察单位,3:设计单位,4:监理单位,5:施工单位'")
	private String type;

	@Column(nullable = false, length = 32, columnDefinition = "varchar(32) COMMENT '企业法人'")
	private String businessCorporation;

	@Column(nullable = false, length = 512, columnDefinition = "varchar(512) COMMENT '公司地址'")
	private String address;

	@Column(nullable = false, length = 512, columnDefinition = "varchar(512) COMMENT '营业执照'")
	private String businessLicense;

	@OneToMany(targetEntity = EmployeeInfo.class, orphanRemoval = true)
