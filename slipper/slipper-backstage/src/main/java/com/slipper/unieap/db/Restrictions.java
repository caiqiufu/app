...
public class Restrictions {
	...
	public static SimpleExpression eq(String fieldName, Object value, boolean ignoreNull) {
		if (ignoreNull && (value == null || StringUtils.isEmpty(value.toString()))) {
			return null;
		}
	 ...
	 * 或者查询User中Set<Address>的Address的name为"北京"的所有User集合 集合可以为基本类型或者JavaBean，可以是one
	 * to many或者是@ElementCollection
	 * 
	 * @param fieldName 列名
	 * @param value     集合
	 * @return expresssion
