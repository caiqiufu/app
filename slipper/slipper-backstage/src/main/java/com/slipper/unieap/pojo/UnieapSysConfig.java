...
@Table(name = "unieap_sys_config")

public class UnieapSysConfig implements Serializable {
	...
	@Column(nullable = true, length = 500, columnDefinition = "varchar(500) COMMENT '值'")
