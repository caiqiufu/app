...
@Table(name = "projectoa_project_leader")
public class ProjectLeader implements Serializable {
	...
	@Column(nullable = true, length = 32, columnDefinition = "varchar(32) COMMENT '单位类型 COMPANY_TYPE,1:建设单位,2:勘察单位,3:设计单位,4:监理单位,5:施工单位'")
	private String companyType;

	@Column(nullable = false, length = 512, columnDefinition = "varchar(512) COMMENT '单位名称'")
	private String companyName;

	@Column(nullable = true, length = 32, columnDefinition = "varchar(32) COMMENT '项目负责人'")
	private String leaderName;
	
	@Column(nullable = true, length = 32, columnDefinition = "varchar(512) COMMENT '证件号码'")
	private String idNumber;

	@Column(nullable = true, length = 32, columnDefinition = "varchar(512) COMMENT '联系电话'")
	private String phone;

	@Column(nullable = false, length = 20, columnDefinition = "BIGINT(20) COMMENT '顺序'")
	private Long seq;
