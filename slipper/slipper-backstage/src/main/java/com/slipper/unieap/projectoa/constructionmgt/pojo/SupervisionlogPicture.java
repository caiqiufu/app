...
@Table(name = "projectoa_supervisionlog_picture")
public class SupervisionlogPicture implements Serializable {
	...
	@Column(nullable = false, length = 20, columnDefinition = "BIGINT(20) COMMENT '监理ID'")
	private Long logId;
	
	@Column(nullable = true, length = 32, columnDefinition = "varchar(32) COMMENT '图片名称'")
	private String pictureName;
	
	@Column(nullable = true, length = 512, columnDefinition = "varchar(512) COMMENT '图片ID，，多个以逗号分割'")
