<template>
	<view class="top-window-header">
		<view class="left-header logo">
			<navigator class="logo" open-type="reLaunch" url="/pages/unieap/ea/me/myinfo">
	...
	export default {
		data() {
			return {
				...
				current: 0,
				indexPage: [{
					tabBar: '/pages/uniap/ea/mybill',
					index: '/pages/uniap/ea/mybill/index'
				}, {
					tabBar: '/pages/uniap/ea/myagent',
					index: '/pages/uniap/ea/myagent/index'
				}, {
					tabBar: '/pages/uniap/ea/myaccount',
					index: '/pages/uniap/ea/myaccount/index'
				}, {
					tabBar: '/pages/uniap/ea/me',
					index: '/pages/uniap/ea/me/myinfo'
				}]
			}
		},
		watch: {
