...
const pages = [
  {
    path: "pages/unieap/projectoa/jldailylog/index",
    style: {
  ...
  {
    path: "pages/unieap/projectoa/jldailylog/loglist",
    style: {
  ...
  {
    path: "pages/unieap/projectoa/jldailylog/edit",
    style: {
  ...
  {
    path: "pages/unieap/projectoa/jldailylog/approve",
    style: {
      navigationBarTitleText: "审核日志",
      enablePullDownRefresh: false
    }
  },
  {
    path: "pages/unieap/projectoa/jldailylog/approvelist",
    style: {
  ...
  {
    path: "pages/unieap/projectoa/jldailylog/view",
    style: {
...
const tabBar = {
  ...
  list: [
    {
      pagePath: "pages/unieap/projectoa/jldailylog/index",
      iconPath: "static/component.png",
      selectedIconPath: "static/componentHL.png",
      text: "新增日志"
    },
    {
      pagePath: "pages/unieap/projectoa/jldailylog/loglist",
    ...
    }
    {
      ...
      if (!index.__stat_uniCloud_space) {
        if (space && Object.keys(space).length !== 0) {
          ...
          index.__stat_uniCloud_space = Ds.init(spaceData);
        } else {
          console.error(
