...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    y: common_vendor.sr("popup", "28471beb-6"),
    ...
    C: common_vendor.sr("message", "28471beb-7"),
    D: common_vendor.p({
      type: "message"
    }),
    ...
    H: common_vendor.sr("alertDialog", "28471beb-9"),
    I: common_vendor.p({
      type: "dialog"
    }),
    J: common_vendor.sr("inputClose", "28471beb-12,28471beb-11"),
    ...
    M: common_vendor.sr("inputDialog", "28471beb-11"),
    N: common_vendor.p({
      type: "dialog"
    }),
    O: common_vendor.sr("share", "28471beb-13"),
    P: common_vendor.p({
      type: "share",
      safeArea: true,
      backgroundColor: "#fff"
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "C:/Users/caiqi/Documents/HBuilderProjects/unieap-slipper-app/pages/extUI/popup/popup.vue"]]);
