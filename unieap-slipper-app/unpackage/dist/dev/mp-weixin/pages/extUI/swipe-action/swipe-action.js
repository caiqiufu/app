  ...
  return {
    ...
    x: common_vendor.f($data.swipeList, (item, index, i0) => {
      return {
        ...
        e: "4ddaf39e-14-" + i0 + ",4ddaf39e-13",
        f: common_vendor.p({
          ["right-options"]: item.options
        })
      };
    }),
    y: common_vendor.sr("swipeAction", "4ddaf39e-13")
  };
}
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "C:/Users/caiqi/Documents/HBuilderProjects/unieap-slipper-app/pages/extUI/swipe-action/swipe-action.vue"]]);
