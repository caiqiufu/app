  ...
  return {
    ...
    e: common_vendor.f($data.tableData, (item, index, i0) => {
      return {
        ...
        b: "2d8a4eaf-7-" + i0 + "," + ("2d8a4eaf-6-" + i0),
        c: common_vendor.t(item.name),
        d: "2d8a4eaf-8-" + i0 + "," + ("2d8a4eaf-6-" + i0),
        e: common_vendor.t(item.address),
        f: "2d8a4eaf-9-" + i0 + "," + ("2d8a4eaf-6-" + i0),
        g: "2d8a4eaf-10-" + i0 + "," + ("2d8a4eaf-6-" + i0),
        h: index,
        i: "2d8a4eaf-6-" + i0 + ",2d8a4eaf-0"
      };
    }),
    f: common_vendor.p({
      align: "center"
    }),
    g: common_vendor.sr("table", "2d8a4eaf-0"),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "C:/Users/caiqi/Documents/HBuilderProjects/unieap-slipper-app/pages/extUI/table/table.vue"]]);
