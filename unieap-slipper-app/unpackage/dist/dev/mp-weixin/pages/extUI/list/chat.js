...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    g: common_vendor.f($data.listData, (item, k0, i0) => {
      return {
        a: "1d4271ea-10-" + i0 + "," + ("1d4271ea-9-" + i0),
        b: item.id,
        c: "1d4271ea-9-" + i0 + ",1d4271ea-8",
        d: common_vendor.p({
          title: item.author_name,
          avatar: item.cover,
          note: item.title,
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "C:/Users/caiqi/Documents/HBuilderProjects/unieap-slipper-app/pages/extUI/list/chat.vue"]]);
