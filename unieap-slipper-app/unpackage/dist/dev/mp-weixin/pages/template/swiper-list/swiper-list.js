...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    f: common_vendor.f($data.tabList, (page, index, i0) => {
      return {
        a: common_vendor.sr("page", "ec82e0b0-0-" + i0, {
          "f": 1
        }),
        b: "ec82e0b0-0-" + i0,
        c: common_vendor.p({
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "C:/Users/caiqi/Documents/HBuilderProjects/unieap-slipper-app/pages/template/swiper-list/swiper-list.nvue"]]);
