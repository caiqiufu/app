  ...
  methods: {
    ...
    submit(optType) {
      ...
      this.$refs["baseForm"].validate().then((res) => {
        ...
        common_vendor.index.request({
          url: this.$baseUrl + "/backstage/projectoa/inf/create?token=" + common_vendor.index.getStorageSync("token"),
          method: "POST",
  ...
  return {
    ...
    i: common_vendor.f($data.baseFormData.deliveryBuildingpartList, (buildingPartInfo, index, i0) => {
      return {
        ...
        e: "3399e08c-6-" + i0 + "," + ("3399e08c-5-" + i0),
        f: common_vendor.p({
          label: "施工部位" + (index + 1)
        }),
        g: "3399e08c-9-" + i0 + "," + ("3399e08c-8-" + i0),
        ...
        k: "3399e08c-8-" + i0 + "," + ("3399e08c-5-" + i0),
        l: common_vendor.p({
          label: "施工内容" + (index + 1)
        }),
        m: "3399e08c-11-" + i0 + "," + ("3399e08c-10-" + i0),
    ...
    U: common_vendor.sr("baseForm", "3399e08c-0"),
    V: common_vendor.p({
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "C:/Users/caiqi/Documents/HBuilderProjects/unieap-slipper-app/pages/unieap/projectoa/jldailylog/view.vue"]]);
