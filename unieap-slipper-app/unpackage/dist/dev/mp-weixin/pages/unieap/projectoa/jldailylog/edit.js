  ...
  return {
    ...
    i: common_vendor.f($data.baseFormData.deliveryBuildingpartList, (buildingPartInfo, index, i0) => {
      return {
        ...
        e: "4bcfd971-6-" + i0 + "," + ("4bcfd971-5-" + i0),
        f: common_vendor.p({
          label: "施工部位" + (index + 1)
        }),
        g: "4bcfd971-9-" + i0 + "," + ("4bcfd971-8-" + i0),
        ...
        k: "4bcfd971-8-" + i0 + "," + ("4bcfd971-5-" + i0),
        l: common_vendor.p({
          label: "施工内容" + (index + 1)
        }),
        m: "4bcfd971-11-" + i0 + "," + ("4bcfd971-10-" + i0),
    ...
    W: common_vendor.sr("baseForm", "4bcfd971-0"),
    X: common_vendor.p({
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "C:/Users/caiqi/Documents/HBuilderProjects/unieap-slipper-app/pages/unieap/projectoa/jldailylog/edit.vue"]]);
