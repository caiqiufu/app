<template>
	<view class="upgrade-popup">
		<image class="header-bg" src="/static/play.png" mode="widthFix"></image>
		<view class="main">
	...
	export default {
		...
		methods: {
			...
			init() {
				...
				setTimeout(() => {
                   //演示数据请根据实际修改
					this.versionName = 'V1.0.0'; //版本名称
					this.versionDesc = "修复若干bug"; //更新说明
					this.downloadUrl = 'http://localhost:8806/slipper/file/__UNI__8DC52A6__20240303190854.apk'; //下载链接
