...
@Data
public class QueryDicVO implements Serializable {
	/**
	 * 
	 */
	 ...
	 * @param seq
	 */
	public QueryDicVO(String groupCode, String tableName, String dicCode, String dicName, String whereby, String seq) {
		super();
		this.groupCode = groupCode;
	...
	public String getSql() {
		...
		sql.append(" select " + this.dicCode + " as dicCode,'root' as parentCode,");
